        ...
        <div class="swiper w-full h-full">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide relative">
                    ...
                    <div class="relative z-20 container mx-auto px-4 h-full flex items-center justify-center">
                        <div class="text-center">
                            <h1 class="text-hero-heading leading-tight text-white font-semibold mb-4 scroll_fadeInUp">Trust - it's what we build.</h1>
                            <p class="text-lg font-light mb-4 text-white text-center scroll_fadeInUp">Ensuring customer satisfaction through delivery of true value in all our dealings.</p>
                            <div class="flex flex-col sm:flex-row gap-4 justify-center scroll_fadeInUp">
                ...
                <div class="swiper-slide relative">
                    ...
                    <div class="relative z-20 container mx-auto px-4 h-full flex items-center justify-center">
                        <div class="text-center text-white">
                            <h1 class="text-hero-heading leading-tight text-white font-semibold mb-4 scroll_fadeInUp">Always deliver more than expected</h1>
                            <p class="text-lg font-light mb-6 scroll_fadeInUp">We lead by serving you to the best of our ability.</p>
                            <div class="flex flex-col sm:flex-row gap-4 justify-center scroll_fadeInUp">
                                <a href="#contact" class="inline-block px-6 py-2 text-white hover:text-secondary-100 font-medium rounded-md backdrop-blur-md border border-white/50">
                                    Schedule a Visit
                                </a>
                ...
                <div class="swiper-slide relative">
                    ...
                    <div class="relative z-20 container mx-auto px-4 h-full flex items-center justify-center">
                        <div class="text-center text-white">
                            <h1 class="text-hero-heading leading-tight text-white font-semibold mb-4 scroll_fadeInUp">Elegant and comfort in a modern Space</h1>
                            <p class="text-lg font-light mb-6 scroll_fadeInUp">
                ...
                <div class="swiper-slide relative">
                    ...
                    <div class="relative z-20 container mx-auto px-4 h-full flex items-center justify-center">
                        <div class="text-center text-white">
                            <h1 class="text-hero-heading leading-tight text-white font-semibold mb-4 scroll_fadeInUp">Delivering what is promised, on time, every time</h1>
                            <p class="text-lg font-light mb-6 scroll_fadeInUp">
...
<section id="our_journey" class="py-12 md:py-20 bg-white z-0 overflow-hidden">
    <div class="container flex flex-col lg:flex-row gap-5 justify-between items-center">
        <div class="lg:w-[40%] lg:pr-8">
            <span class="text-secondary-900 text-sm font-normal uppercase tracking-wider py-1 px-2 bg-secondary-50" >Our journey</span>
            <h2 class="text-2nd-heading leading-[1.3] mb-5 mt-5 scroll_fadeInUp">
                Luxury living where comfort meets timeless style, effortlessly</h2>
            <p class="text-gray-600 mb-8 scroll_fadeInUp">
            ...
            <a class="btn-main scroll_fadeInUp" href="/about-us/">
                Explore More
            </a>
        </div>
        <div class="lg:w-[60%] grid md:grid-cols-2 gap-5">
            <div class=" bg-gray-100 p-5 rounded-xl scroll_fadeInUp">
...
<section id="featured_projects" class="py-24 bg-[#003333] text-white overflow-hidden z-0 rounded-3xl">
    <div class="container mx-auto px-4">
        <div class="text-center max-w-2xl mx-auto mb-16">
            <span class="text-secondary-100 text-sm font-normal uppercase tracking-wider py-1 px-2 bg-[#1E4645] scroll_fadeInUp">Featured Projects</span>
            <h2 class="text-2nd-heading mb-6 text-white scroll_fadeInUp">Discover Our Projects</h2>
        </div>
            ...
            <div class="tabs w-full">
                ...
                <ul id="tabContents" class="pt-3">
                    <li data-tab-content="tab1" class="block">
                        <div class="flex flex-col lg:flex-row gap-4 justify-between animate__animated animate__fadeIn">
                            <div class="lg:w-1/3">
...
<section id="what_we_do" class="py-24 z-0 overflow-hidden">
    <div class="container">
        <div class="flex flex-wrap justify-center">
            <div class="lg:w-1/2 text-center">
                <span class="subtitle text-secondary-900 text-sm font-normal uppercase tracking-wider py-1 px-2 self-center bg-secondary-50 scroll_fadeInUp">What We Do</span>
                <h2 class="text-2nd-heading scroll_fadeInUp">Our Services</h2>
            </div>
        </div>
        <div class="flex w-full text-center justify-center items-center my-5">
            <ul id="filters" class="  flex flex-wrap justify-center lg:flex-row scroll_fadeInUp">
        ...
        <div id="gallery" class="grid grid-cols-2 lg:grid-cols-3 gap-3">
            <div class="w-full item venture scroll_fadeInUp">
...
<section id="why_innovera" class="bg-[#003333] text-white md:py-24 py-12 z-0 rounded-3xl">
    <div class="container flex flex-col gap-10 items-center justify-center lg:justify-between">
        <div class="w-full flex flex-col items-center text-center">
            <span class="subtitletext-secondary-100 text-sm font-normal uppercase tracking-wider py-1 px-2 bg-[#1E4645] rounded scroll_fadeInUp">Discover</span>
            <h2 class="text-2nd-heading text-white leading-[1.3] scroll_fadeInUp">Why Choose Innovera?</h2>
            <p class="scroll_fadeInUp">
        ...
        <div class="flex flex-col lg:flex-row gap-5">
            <div class="w-full lg:w-1/2 lg:order-last">
                <picture class="flex flex-col items-center">
                    ...
                    <img width="650px" height="auto" src="<?php echo INNOVERA_URI . '/src/images/apartment/why_innovera_d.webp'?>" class="object-cover rounded-2xl animate__animated animate__fadeIn" alt="Discover" loading="lazy" decoding="async">
                </picture>
            </div>
            <div class="icon-list w-full lg:w-1/2">
                <div class="flex items-start mb-4 scroll_fadeInUp animate__delay-2ms">
                    <div class="mr-3">
                ...
                <div class="flex items-start mb-4 scroll_fadeInUp animate__delay-4ms">
                    <div class="mr-3">
                        <i><svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#fdf6ef">
                ...
                <div class="flex items-start mb-4 scroll_fadeInUp animate__delay-6ms">
                    <div class="mr-3">
                        <i><svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#fdf6ef">
                ...
                <div class="flex items-start mb-4 scroll_fadeInUp animate__delay-8ms">
                    <div class="mr-3">
                        <i><svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#fdf6ef">
                ...
                <div class="flex items-start mb-4 scroll_fadeInUp animate__delay-10ms">
                    <div class="mr-3">
                        <i><svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#fdf6ef">
                ...
                <div class="flex items-start mb-4 scroll_fadeInUp animate__delay-12ms">
                    <div class="mr-3">
                        <i><svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#fdf6ef">
                ...
                <div class="flex items-start mb-4 scroll_fadeInUp animate__delay-14ms">
                    <div class="mr-3">
                        <i><svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#fdf6ef">
...
<section id="latest_update" class="py-24 z-0">
    <div class="container ">
        <div class="flex flex-col justify-center text-center mb-5">
            <div class="subtitle text-secondary-900 text-sm font-normal uppercase tracking-wider py-1 px-2 self-center bg-secondary-50 rounded scroll_fadeInUp">Latest Update</div>
            <h2 class="text-2nd-heading scroll_fadeInUp">Media & Event</h2>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            <?php
                ...
                if ($events->have_posts()) :
                    ...
                    <a href="<?php the_permalink(); ?>" class="animate__animated animate__fadeIn">
...
<section id="contact" class="container md:py-24 py-12 z-0">
    <div class="flex flex-col justify-center mb-5 text-center gap-2">
        <span class="subtitle text-secondary-900 text-sm font-normal uppercase tracking-wider py-1 px-2 self-center bg-secondary-50 rounded animate__animated animate__fadeIn">Schedule a Meeting</span>
        <h2 class="text-2nd-heading md:leading-1 leading-none animate__animated animate__fadeIn">Your Dreem Home is Just a Visit Away</h2>
        <p class="lg:text-lg text-base font-normal text-black/50 leading-[1.2] text-center animate__animated animate__fadeIn">Our team is committed to honesty, professionalism, and delivering real value to our clients.</p>
    </div>
    <div class="flex md:flex-row flex-col justify-center items-center lg:gap-10 gap-5 px-5 lg:px-0">
        <div class="lg:w-6/12 md:order-first">
            <picture>
                ...
                <img width="650" height="650" class="rounded-xl animate__animated animate__fadeIn" src="<?php echo INNOVERA_URI . '/src/images/apartment/schedule_meeting_d.webp' ?>" alt="Phone" loading="lazy" decoding="async">
            </picture>
        </div>
        <div id="home_form" class="flex flex-col lg:w-6/12 w-full">
            <a class="flex items-center  gap-2 text-lg font-medium px-3 py-2 mt-4 rounded border border-dashed border-secondary-100 animate__animated animate__fadeIn" href="tel:+8801833156010">
                ...
                <div class="flex flex-col">
                    ...
                    <p class="lg:text-lg text-base font-normal text-black/50 animate__animated animate__fadeIn">+88 01833156010</p>
                </div>
            </a>
            <a class="flex items-center  gap-2 text-lg font-medium px-3 py-2 mt-4 rounded border border-dashed border-secondary-100 animate__animated animate__fadeIn" href="tel:+8802226617206">
                <div class="flex items-center justify-center p-3 rounded-full bg-secondary-50">
                    <svg xmlns="http://www.w3.org/2000/svg" height="28px" width="28px" viewBox="0 -960 960 960" class="fill-secondary-500">
                ...
                <div class="flex flex-col">
                    <h6>BTCL</h6>
                    <p class="lg:text-lg text-base font-normal text-black/50 animate__animated animate__fadeIn">+88 02226617206</p>
                </div>
            </a>
