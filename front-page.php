    ...
    <div class="container">
        <div class="flex flex-wrap justify-center">
            <div class="lg:w-1/2 text-center">
                <span class="subtitle text-secondary-900 text-sm font-normal uppercase tracking-wider py-1 px-2 self-center bg-secondary-100  fadeInUp animated" data--delay=".0s">Dicover Gallery</span>
                <h2 class=" text-2nd-heading  fadeInUp animated" data--delay=".2s">Exterior &amp; Interior</h2>
            </div>
        </div>
...
<section id="why-innovera" class="bg-[#003333] py-24 text-white">
    <div class="container flex flex-col lg:flex-row gap-5 items-center justify-center">
        <div class="w-full lg:w-1/2">
            ...
            <h2 class=" fadeInUp animated text-2nd-heading text-white" data--delay=".4s">Why Choose Innovera?</h2>
            <p class=" fadeInUp animated" data--delay=".6s">
            ...
            <div class="icon-list">
                <div class="flex items-start mb-4 fadeInUp animated" data--delay=".8s">
                    <div class="text-3xl text-secondary-400 mr-4 mt-1">
                        <i class="fas fa-check-circle"></i>
                    </div>
                    <div>
                        <h4 class="text-xl font-semibold mb-1">Trust & Transparency</h4>
        ...
        <div class="w-full lg:w-1/2">
            <img width="720px" src="<?php echo INNOVERA_URI . '/src/images/misc/s4.webp' ?>" class="aspect-square object-cover rounded-2xl  fadeInUp animated" data--delay=".8s" alt="Floorplan">
        </div>
    </div>
</section>
    ...
    <div class="container ">
        ...
        <div class="flex flex-wrap md:flex-nowrap lg:flex-nowrap gap-4">
            <div class="lg:w-1/3 md:w-1/2">
                <div class="overflow-hidden relative rounded-1 text-light text-center  zoomIn animated" data--delay=".0s">
                    <div class=" fadeIn animated overflow-hidden rounded-lg" data--delay=".4s">
            ...
            <div class="lg:w-1/3 md:w-1/2">
                <div class="overflow-hidden relative rounded-1 text-light text-center  zoomIn animated" data--delay=".0s">
                    <div class=" fadeIn animated overflow-hidden rounded-lg" data--delay=".6s">
            ...
            <div class="lg:w-1/3 md:w-1/2">
                <div class="overflow-hidden relative rounded-1 text-light text-center  zoomIn animated" data--delay=".0s">
                    <div class=" fadeIn animated overflow-hidden rounded-lg" data--delay=".8s">
    ...
    <div class="container">
        <div class="flex justify-center mb-5">
            <div class="text-center">
                <span class="subtitle text-secondary-900 text-sm font-normal uppercase tracking-wider py-1 px-2 self-center bg-secondary-100  fadeInUp animated rounded" data--delay=".0s">Schedule a Meeting</span>
                <h2 class=" fadeInUp animated text-2nd-heading" data--delay=".2s">Your Dreem Home is Just a Visit Away</h2>
            </div>
        </div>
