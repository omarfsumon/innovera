...
<section id="featured_projects" class="py-24 bg-[#003333] text-white overflow-hidden z-0">
    <div class="container mx-auto px-4">
        <div class="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 class="text-2nd-heading mb-6 text-white" data-aos="flip-up" data-aos-delay="100">Discover Our Projects</h2>
        </div>
...
<section id="what_we_do" class=" bg-secondary-50 py-24 z-0">
    <div class="container">
        ...
        <div class="flex w-full text-center justify-center items-center mb-12 mt-10">
            <ul id="filters" class="  flex flex-wrap justify-center lg:flex-row" data-aos="fade-up" data-aos-delay="100">
        ...
        <div id="gallery" class="grid grid-cols-2 lg:grid-cols-3 gap-3">
            <div class="w-full item venture" data-aos="zoom-in" data-aos-delay="100">
            ...
            <div class="w-full item venture" data-aos="zoom-in" data-aos-delay="200">
            ...
            <div class="w-full item venture" data-aos="zoom-in" data-aos-delay="300">
    ...
    <div class="container flex flex-col lg:flex-row gap-5 items-center justify-center lg:justify-between">
        <div class="w-full lg:w-1/2">
            ...
            <div class="icon-list mt-3">
                ...
                <div class="flex items-start mb-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="mr-3">
                        <i><svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#fdf6ef">
                ...
                <div class="flex items-start mb-4" data-aos="fade-up" data-aos-delay="400">
                    <div class="mr-3">
                        <i><svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#fdf6ef">
                ...
                <div class="flex items-start mb-4" data-aos="fade-up" data-aos-delay="500">
                    <div class="mr-3">
                        <i><svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#fdf6ef">
                ...
                <div class="flex items-start mb-4" data-aos="fade-up" data-aos-delay="600">
                    <div class="mr-3">
                        <i><svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#fdf6ef">
                ...
                <div class="flex items-start mb-4" data-aos="fade-up" data-aos-delay="700">
                    <div class="mr-3">
                        <i><svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#fdf6ef">
                ...
                <div class="flex items-start mb-4" data-aos="fade-up" data-aos-delay="800">
                    <div class="mr-3">
                        <i><svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#fdf6ef">
...
<section id="contact" class="py-24 z-0">
    <div class="container">
        <div class="flex justify-center mb-5">
            <div class="text-center">
                <span 
                class="subtitle text-secondary-900 text-sm font-normal uppercase tracking-wider py-1 px-2 self-center bg-secondary-100 rounded"
                data-aos="fade-up" data-aos-delay="100"
