    ...
    <div class="container">
        ...
        <div class="flex flex-col md:flex-row items-center gap-5 mt-5">
            <div class="md:w-[50%] w-full">
                ...
                class="w-full h-auto" data-aos="fade-up" data-aos-duration="1000">
            </div>
            <div class="md:w-[50%] w-full flex flex-col gap-2">
                <div class="flex flex-col gap-1 p-3 border border-secondary-100" data-aos="fade-up" data-aos-duration="1000">
...
<section class="md:py-16 py-10 bg-white">
    <div class="container">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-5 mt-5">
            <div class="flex flex-col p-5 rounded-lg gap-2 shadow items-center text-center hover:shadow-lg transition duration-300" data-aos="zoom-in" data-aos-duration="1000">
