...
<section class="md:py-16 py-4 bg-[#fefefc]">
    <div class="container flex md:flex-row flex-col items-center gap-10">
        ...
        <div class="md:w-[55%] w-full">
            <h2 class="text-2nd-heading leading-[1.2] mb-2 font-[400]" data-aos="fade-right" data-aos-duration="1000">Interior & Customization</h2>
            <p class="mb-2" data-aos="fade-right" data-aos-duration="1000">
...
<section class="md:py-16 py-10 bg-white">
    <div class="container">
        <h2 class="text-2nd-heading leading-[1.2] mb-2 font-[400] text-center" data-aos="flip-up" data-aos-duration="1000">How It Works</h2>
        <div class="flex flex-col md:flex-row items-center gap-10 mt-10">
            <div class="md:w-[50%] w-full">
                ...
                class="w-full h-auto rounded-lg" data-aos="fade-right" data-aos-duration="1000">
            </div>
...
<section class="md:py-16 py-10 bg-white">
    <div class="container">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-5 mt-5">
            <div class="flex flex-col p-5 rounded-lg gap-2 shadow justify-center items-center text-center hover:shadow-lg transition duration-300 aspect-square" data-aos="zoom-in" data-aos-duration="1000">
                ...
                <h4 class="text-2xl leading-[1.2]">Make your home truly yours.</h4>
            </div>
            <div class="flex flex-col p-5 rounded-lg gap-2 shadow justify-center items-center text-center hover:shadow-lg transition duration-300 aspect-square" data-aos="zoom-in" data-aos-duration="1000">
                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" class="fill-secondary-500" width="50px" height="50px">
                ...
                <h4 class="leading-[1.2] text-2xl">Quality assurance with branded materials.</h4>
            </div>
            <div class="flex flex-col p-5 rounded-lg gap-2 shadow justify-center items-center text-center hover:shadow-lg transition duration-300 aspect-square" data-aos="zoom-in" data-aos-duration="1000">
                ...
                <h4 class="text-2xl leading-[1.2]">Timely delivery without construction delays.</h4>
            </div>
            <div class="flex flex-col p-5 rounded-lg gap-2 shadow justify-center items-center text-center hover:shadow-lg transition duration-300 aspect-square" data-aos="zoom-in" data-aos-duration="1000">
                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" class="fill-secondary-500" width="50px" height="50px">
                ...
                <h4 class="text-2xl leading-[1.2]">Cost-efficient packages with flexible budgets.</h4>
            </div>
        </div>
    </div>
</section>
