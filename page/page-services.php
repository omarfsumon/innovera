...
<section id="home_loan" class="py-5 md:py-15 overflow-hidden">
...
<section id="property_management" class=" py-5 md:py-20 overflow-hidden">
    <div class="container flex flex-col md:flex-row items-center justify-between md:gap-20 gap-5">
...
<section class="md:py-16 py-10 overflow-hidden">
    <div class="container">
        <h2 class="text-3rd-heading leading-[1.2] mb-2 font-[400] text-center scroll_animate" data-animate="animate__flipInX">For Whom?</h2>
        <div class="grid grid-cols-1 md:grid-cols-4 gap-5 mt-5">
            <div class="flex flex-col p-5 rounded-lg gap-2 shadow hover:shadow-lg transition duration-300 bg-white scroll_animate" style="animation-delay: 0.1s;">
                <span class="block"><?php get_template_part('src/svg/check', 'check'); ?></span>
                <h4 class="text-xl">Apartment Owners (living abroad or busy with work)</h4>
            </div>
            <div class="flex flex-col p-5 rounded-lg gap-2 shadow hover:shadow-lg transition duration-300 bg-white scroll_animate" style="animation-delay: 0.2s;">
                <span class="block"><?php get_template_part('src/svg/check', 'check'); ?></span>
                <h4 class="text-xl">Landlords who rent out units</h4>
            </div>
            <div class="flex flex-col p-5 rounded-lg gap-2 shadow hover:shadow-lg transition duration-300 bg-white scroll_animate" style="animation-delay: 0.3s;">
                <span class="block"><?php get_template_part('src/svg/check', 'check'); ?></span>
                <h4 class="text-xl">Housing Societies & Commercial Complex Owners</h4>
            </div>
            <div class="flex flex-col p-5 rounded-lg gap-2 shadow hover:shadow-lg transition duration-300 bg-white scroll_animate" style="animation-delay: 0.4s;">
                <span class="block"><?php get_template_part('src/svg/check', 'check'); ?></span>
                <h4 class="text-xl">Investors who want hassle-free returns</h4>
            </div>
        </div>
    </div>
</section>
...
<section class="md:py-16 py-10 bg-secondary-50 overflow-hidden">
    <div class="container flex flex-col gap-5">
        <h2 class="text-2nd-heading text-center font-medium leading-tight scroll_animate" data-animate="animate__flipInX">Construction on Contract Service</h2>
            <div class="flex flex-col md:flex-row gap-5 scroll_animate" style="animation-delay: 0.1s;">
                <picture class="md:w-1/2">
                    <source srcset="<?php echo get_template_directory_uri(); ?>/src/images/service/build_dreem.webp" type="image/webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/src/images/service/build_dreem.webp" alt="Contract Construction Service" class="mx-auto mt-5 rounded-xl shadow-xl w-full max-w-xl">
                </picture>
                <div class="md:w-1/2 flex flex-col justify-center">
                    <h5 class="text-3rd-heading">Building Your Dream, the Professional Way</h5>
                    <p>At <strong>Innovera Holdings Ltd.</strong>, we offer <strong>Construction on Contract Services</strong>  to clients who already own land but wish to build their dream home, commercial space, 
                        or apartment complex with the assurance of professional expertise, quality, and transparency. 
                        This service is designed for landowners who want to avoid the hassle of managing construction themselves while ensuring cost efficiency and timely delivery.</p>
                </div>
            </div>

            <div class="flex flex-col gap-5 mt-10 relative">
                <h5 class="text-3rd-heading text-center">Key Features of Our Contract Construction Service</h5>
                <div class="flex flex-col scroll_animate" style="animation-delay: 0.1s;">
                    <ol class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 list-decimal list-inside mb-3 leading-[1.4] space-y-2 text-black/70 key_features">
                        <li>
                            <h4 class="leading-[1.2] text-xl mb-4">Customized Design & Planning</h4>
                            <ul class="list-disc list-outside ml-8 leading-[1.4] space-y-2 text-black/70">
                                <li>Architectural design tailored to client requirements.</li>
                                <li>Structural, electrical, plumbing, and utility planning by certified engineers.</li>
                            </ul>
                        </li>
                        <li>
                            <h4 class="leading-[1.2] text-xl mb-4">Transparent Costing</h4>
                            <ul class="list-disc list-outside ml-8 leading-[1.4] space-y-2 text-black/70">
                                <li>Detailed BOQ (Bill of Quantities) and cost estimation provided in advance.</li>
                                <li>No hidden charges – clear breakdown of materials, labor, and service fees.</li>
                            </ul>
                        </li>
                        <li>
                            <h4 class="leading-[1.2] text-xl mb-4">Quality Materials & Workmanship</h4>
                            <ul class="list-disc list-outside ml-8 leading-[1.4] space-y-2 text-black/70">
                                <li>Use of standard or premium-grade construction materials as per contract.</li>
                                <li>Supervision by experienced project managers and site engineers.</li>
                            </ul>
                        </li>
                        <li>
                            <h4 class="leading-[1.2] text-xl mb-4">Time-Bound Delivery</h4>
                            <ul class="list-disc list-outside ml-8 leading-[1.4] space-y-2 text-black/70">
                                <li>Strict project timelines with milestones.</li>
                                <li>Regular progress updates and reporting to the client.</li>
                            </ul>
                        </li>
                        <li>
                            <h4 class="leading-[1.2] text-xl mb-4">Compliance & Safety</h4>
                            <ul class="list-disc list-outside ml-8 leading-[1.4] space-y-2 text-black/70">
                                <li>Construction carried out as per RAJUK/City Corporation regulations.</li>
                                <li>Full adherence to building codes and safety standards.</li>
                            </ul>
                        </li>
                        <li> 
                            <h4 class="leading-[1.2] text-xl mb-4">Flexible Packages</h4>
                            <ul class="list-disc list-outside ml-8 leading-[1.4] space-y-2 text-black/70">
                                <li><strong>Turnkey Solution:</strong> From design to handover, complete construction responsibility is ours.</li>
                                <li><strong>Labor + Supervision Model:</strong> Client provides materials, and we manage labor and execution.</li>
                                <li><strong>Hybrid Model:</strong> Flexible sharing of materials and services based on client’s preference.</li>
                            </ul>
                        </li>
                    </ol>
                </div>
...
<section class="md:py-16 py-10 overflow-hidden">
    <div class="container">
        <h2 class="text-3rd-heading leading-[1.2] mb-2 font-[400] text-center scroll_animate" data-animate="animate__flipInX">Benefits for the Client</h2>
        <div class="grid grid-cols-1 md:grid-cols-4 gap-5 mt-5">
            <div class="flex flex-col p-5 rounded-lg gap-2 shadow hover:shadow-lg transition duration-300 bg-white scroll_animate" style="animation-delay: 0.1s;">
                <span class="block"><?php get_template_part('src/svg/check', 'check'); ?></span>
                <h4 class="text-xl">Hassle-free construction management.</h4>
            </div>
            <div class="flex flex-col p-5 rounded-lg gap-2 shadow hover:shadow-lg transition duration-300 bg-white scroll_animate" style="animation-delay: 0.2s;">
                <span class="block"><?php get_template_part('src/svg/check', 'check'); ?></span>
                <h4 class="text-xl">Professional supervision ensures durability and quality.</h4>
            </div>
            <div class="flex flex-col p-5 rounded-lg gap-2 shadow hover:shadow-lg transition duration-300 bg-white scroll_animate" style="animation-delay: 0.3s;">
                <span class="block"><?php get_template_part('src/svg/check', 'check'); ?></span>
                <h4 class="text-xl">Saves time, effort, and cost by avoiding mismanagement.</h4>
            </div>
            <div class="flex flex-col p-5 rounded-lg gap-2 shadow hover:shadow-lg transition duration-300 bg-white scroll_animate" style="animation-delay: 0.4s;">
                <span class="block"><?php get_template_part('src/svg/check', 'check'); ?></span>
                <h4 class="text-xl">Peace of mind with reliable contract agreements.</h4>
            </div>
        </div>
    </div>
</section>
