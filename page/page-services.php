...
<section class="bg-[#003333] py-8 px-4 sm:py-16 lg:px-6">
  <div class="container mx-auto">
      <div class="max-w-screen-md mb-8 lg:mb-16">
          <h2 class="mb-4 text-2nd-heading font-normal text-white">After Handover Service</h2>
          <h4>Your Home, Our Commitment</h4>
          <p class="text-gray-500">
            At Innovera Holdings Ltd., our relationship with you doesn’t end once the keys are handed over. 
            We provide comprehensive after-handover services to ensure that your new home remains safe, 
            functional, and enjoyable long after you move in.
        </p>
      </div>
